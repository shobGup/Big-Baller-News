...
# method that finds all of the espn articles and links and 
# returns an array with the num of articles, an array of 
# the article links, and an array of the article titles
def espn():
    r1 = requests.get('https://www.espn.com/nba/')
    coverpage = r1.content
    soup1 = BeautifulSoup(coverpage, 'html5lib')
    ...
    for i in range(0, len(news_cards_espn) - 1):
        ...
        if (i != 1): 
            ...
            article_links_espn.append(article.a.get('href')) 
    espn_info = {len(article_links_espn), article_links_espn, article_titles_espn}
    return espn_info

# method that finds all of the nba articles and links and 
# returns an array with the num of articles, an array of 
# the article links, and an array of the article titles
def nba():
    r4 = requests.get('https://www.nba.com/')
    ...
    for i in range (1, len(news_cards_nba)):
        ...
        article_titles_nba.append(article.a.text)
        article_links_nba.append('https://www.nba.com/' + (article.a.get('href')))
    nba_info = {len(article_links_nba), article_links_nba, article_titles_nba}
    return nba_info


# method that finds all of the Bleacher Report articles and links and 
# returns an array with the num of articles, an array of 
# the article links, and an array of the article titles
def bleacher_report():
    r2 = requests.get('https://bleacherreport.com/nba')
    ...
    for i in range (len (news_cards_br)):
        ...
        article_titles_br.append(article.h3.text)
        article_links_br.append(article.get('href'))
    bleacher_report_info = {len(article_links_br), article_links_br, article_titles_br}
    return bleacher_report_info


# method that finds all of the Athletic articles and links and 
# returns an array with the num of articles, an array of 
# the article links, and an array of the article titles
def athletic():
    r3 = requests.get('https://theathletic.com/nba/')
    ...
    for i in range (len(news_cards_ath)):
        ...
        article_titles_ath.append(article.span.text)
        article_links_ath.append(article.a.get('href'))
    athletic_info = {len(article_links_ath), article_links_ath, article_titles_ath}
    return athletic_info
